  ...
  _Container(double width, int index, WorksUtils worksUtils) {
    return InkWell(
      ...
      child: Container(
        ...
        child: isHovered[index] ? Stack(
          children: [Positioned.fill(child: Container(height: screenWidth < 1300 ? 35.h : 45.h,
          width: width, padding: EdgeInsets.symmetric(horizontal: 1.w, vertical: 2.h), decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), gradient: LinearGradient(colors: )),))],
        ),
      ),
    );
  }
